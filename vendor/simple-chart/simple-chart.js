simple_chart = function(div, data){
	...
	for (n in data.data){
		...
		$(div).append('<div style="float: left; width: ' + lebar_elemen + 'px; height: ' + height + 'px;"><div style="height: ' + height_kosong + 'px;"></div><div style="height: ' + height_elemen + 'px; background: ' + data.background[n] + '; color: '+ data.color[n] + ';"></div></div>')
	}
}